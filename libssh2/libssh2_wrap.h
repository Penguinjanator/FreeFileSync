...
std::wstring formatSshStatusCode(int sc)
{
    switch (sc)
    {
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_NONE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SOCKET_NONE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_BANNER_RECV);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_BANNER_SEND);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_INVALID_MAC);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_KEX_FAILURE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_ALLOC);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SOCKET_SEND);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_KEY_EXCHANGE_FAILURE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_TIMEOUT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_HOSTKEY_INIT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_HOSTKEY_SIGN);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_DECRYPT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SOCKET_DISCONNECT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_PROTO);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_PASSWORD_EXPIRED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_FILE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_METHOD_NONE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_AUTHENTICATION_FAILED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_PUBLICKEY_UNVERIFIED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_OUTOFORDER);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_FAILURE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_REQUEST_DENIED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_UNKNOWN);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_WINDOW_EXCEEDED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_PACKET_EXCEEDED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_CLOSED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_EOF_SENT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SCP_PROTOCOL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_ZLIB);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SOCKET_TIMEOUT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SFTP_PROTOCOL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_REQUEST_DENIED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_METHOD_NOT_SUPPORTED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_INVAL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_INVALID_POLL_TYPE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_PUBLICKEY_PROTOCOL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_EAGAIN);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_BUFFER_TOO_SMALL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_BAD_USE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_COMPRESS);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_OUT_OF_BOUNDARY);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_AGENT_PROTOCOL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_SOCKET_RECV);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_ENCRYPT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_BAD_SOCKET);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_KNOWN_HOSTS);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_CHANNEL_WINDOW_FULL);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_KEYFILE_AUTH_FAILED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_RANDGEN);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_MISSING_USERAUTH_BANNER);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_ALGO_UNSUPPORTED);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_MAC_FAILURE);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_HASH_INIT);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_HASH_CALC);
            ZEN_CASE_RETURN_STRING(LIBSSH2_ERROR_STORE_OVERFLOW);
